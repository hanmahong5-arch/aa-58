...
/**
 * PostgreSQL implementation of PlayerTransformDAO
 * @author
 */
public class PostgreSQLPlayerTransfoDAO extends PlayerTransformDAO {

    private static final Logger log = LoggerFactory.getLogger(PostgreSQLPlayerTransfoDAO.class);

    private static final String INSERT_QUERY = "INSERT INTO \"player_transform\" (\"player_id\", \"panel_id\", \"item_id\") VALUES (?, ?, ?) " + "ON CONFLICT (player_id, panel_id) DO UPDATE SET panel_id = EXCLUDED.panel_id, item_id = EXCLUDED.item_id";

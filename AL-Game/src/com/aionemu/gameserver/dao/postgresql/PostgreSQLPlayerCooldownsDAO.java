...
/**
 * PostgreSQL implementation of PlayerCooldownsDAO
 * @author nrg
 */
public class PostgreSQLPlayerCooldownsDAO extends PlayerCooldownsDAO {

    private static final Logger log = LoggerFactory.getLogger(PostgreSQLPlayerCooldownsDAO.class);

    private static final String INSERT_QUERY = "INSERT INTO \"player_cooldowns\" (\"player_id\", \"cooldown_id\", \"reuse_delay\") " + "VALUES (?, ?, ?) " + "ON CONFLICT (player_id, cooldown_id) DO UPDATE SET reuse_delay = EXCLUDED.reuse_delay";

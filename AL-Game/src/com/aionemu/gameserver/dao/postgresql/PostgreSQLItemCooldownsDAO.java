 ...
 */
public class PostgreSQLItemCooldownsDAO extends ItemCooldownsDAO {

	private static final Logger log = LoggerFactory.getLogger(PostgreSQLItemCooldownsDAO.class);

	private static final String INSERT_QUERY = "INSERT INTO \"item_cooldowns\" (\"player_id\", \"delay_id\", \"use_delay\", \"reuse_time\") VALUES (?,?,?,?) " + "ON CONFLICT (player_id, delay_id) DO UPDATE SET use_delay = EXCLUDED.use_delay, reuse_time = EXCLUDED.reuse_time";

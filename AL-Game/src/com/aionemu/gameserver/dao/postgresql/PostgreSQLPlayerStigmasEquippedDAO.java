...
public class PostgreSQLPlayerStigmasEquippedDAO extends PlayerStigmasEquippedDAO {

    private static final Logger log = LoggerFactory.getLogger(PostgreSQLPlayerStigmasEquippedDAO.class);

 ...
 */
public class PostgreSQLPlayerShugoSweepDAO extends PlayerShugoSweepDAO {

    private static final Logger log = LoggerFactory.getLogger(PostgreSQLPlayerShugoSweepDAO.class);

 ...
 */
public class PostgreSQLPlayerNpcFactionsDAO extends PlayerNpcFactionsDAO {

	private static final Logger log = LoggerFactory.getLogger(PostgreSQLPlayerNpcFactionsDAO.class);

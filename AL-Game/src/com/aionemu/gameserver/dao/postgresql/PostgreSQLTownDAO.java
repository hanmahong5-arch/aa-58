...
/**
 * PostgreSQL implementation of TownDAO
 * @author ViAl
 */
public class PostgreSQLTownDAO extends TownDAO {

    private static final Logger log = LoggerFactory.getLogger(PostgreSQLTownDAO.class);
    ...
    private static final String UPSERT_QUERY = "INSERT INTO \"towns\" (\"id\", \"level\", \"points\", \"race\", \"level_up_date\") VALUES (?, ?, ?, ?, ?) " + "ON CONFLICT (id) DO UPDATE SET level = EXCLUDED.level, points = EXCLUDED.points, level_up_date = EXCLUDED.level_up_date";

...
public class PostgreSQLPortalCooldownsDAO extends PortalCooldownsDAO {

	private static final Logger log = LoggerFactory.getLogger(PostgreSQLPortalCooldownsDAO.class);

	private static final String INSERT_QUERY = "INSERT INTO \"portal_cooldowns\" (\"player_id\", \"world_id\", \"reuse_time\", \"entry_count\") VALUES (?,?,?,?) " + "ON CONFLICT (player_id, world_id) DO UPDATE SET reuse_time = EXCLUDED.reuse_time, entry_count = EXCLUDED.entry_count";
	...
	public void loadPortalCooldowns(final Player player) {
		ConcurrentHashMap<Integer, PortalCooldownItem> portalCoolDowns = new ConcurrentHashMap<Integer, PortalCooldownItem>();

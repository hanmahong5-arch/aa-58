 ...
 */
public class PostgreSQLAnnouncementsDAO extends AnnouncementsDAO {

	private static final Logger log = LoggerFactory.getLogger(PostgreSQLAnnouncementsDAO.class);

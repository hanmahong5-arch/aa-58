...
/**
 * PostgreSQL implementation of BrokerDAO
 * Fixed connection leaks
 */
public class PostgreSQLBrokerDAO extends BrokerDAO {

    private static final Logger log = LoggerFactory.getLogger(PostgreSQLBrokerDAO.class);

 ...
 */
public class PostgreSQLPlayerThievesDAO extends PlayerThievesListDAO {
	
	private static final Logger log = LoggerFactory.getLogger(PostgreSQLPlayerThievesDAO.class);
	...
	public ThievesStatusList loadThieves(int playerId) {
		...
		try (Connection con = DatabaseFactory.getConnection();
			...
			log.error("Error in PostgreSQLPlayerThievesDAO.loadThieves, playerId: " + playerId, e);
		}
		return thieves;
	}
	...
	public boolean saveNewThieves(ThievesStatusList thieves) {
		try (Connection con = DatabaseFactory.getConnection();
			...
			log.error("Error in PostgreSQLPlayerThievesDAO.saveNewThieves", e);
			return false;
		}
	}

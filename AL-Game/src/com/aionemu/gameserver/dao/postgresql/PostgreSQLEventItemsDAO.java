 ...
 */
public class PostgreSQLEventItemsDAO extends EventItemsDAO {

    private static final Logger log = LoggerFactory.getLogger(PostgreSQLEventItemsDAO.class);
	
    private static final String INSERT_QUERY = "INSERT INTO \"event_items\" (\"player_id\", \"item_id\", \"counts\") VALUES (?,?,?) " + "ON CONFLICT (player_id, item_id) DO UPDATE SET counts = EXCLUDED.counts";

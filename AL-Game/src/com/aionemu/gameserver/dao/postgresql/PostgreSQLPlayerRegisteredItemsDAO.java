...
/**
 * PostgreSQL implementation of PlayerRegisteredItemsDAO
 * Fixed connection leaks
 */
public class PostgreSQLPlayerRegisteredItemsDAO extends PlayerRegisteredItemsDAO {
    
    private static final Logger log = LoggerFactory.getLogger(PostgreSQLPlayerRegisteredItemsDAO.class);
    ...
    public boolean store(HouseRegistry registry, int playerId) {
        ArrayList<HouseObject<?>> objects = registry.getObjects();
        ArrayList<HouseDecoration> decors = registry.getAllParts();

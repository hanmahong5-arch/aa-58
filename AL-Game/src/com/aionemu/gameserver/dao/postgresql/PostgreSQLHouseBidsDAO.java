...
/**
 * PostgreSQL implementation of HouseBidsDAO
 * @author Rolandas
 */
public class PostgreSQLHouseBidsDAO extends HouseBidsDAO {

    private static final Logger log = LoggerFactory.getLogger(PostgreSQLHouseBidsDAO.class);

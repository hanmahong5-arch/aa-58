...
/**
 * PostgreSQL implementation of SiegeDAO
 * @author
 */
public class PostgreSQLSiegeDAO extends SiegeDAO {

    private static final Logger log = LoggerFactory.getLogger(PostgreSQLSiegeDAO.class);

    private static final String SELECT_QUERY = "SELECT \"id\", \"race\", \"legion_id\" FROM \"siege_locations\" ORDER BY \"id\"";
    private static final String INSERT_QUERY = "INSERT INTO \"siege_locations\" (\"id\", \"race\", \"legion_id\") VALUES (?, ?, ?) " + "ON CONFLICT (id) DO UPDATE SET race = EXCLUDED.race, \"legion_id\" = VALUES(\"legion_id\")";

...
public class PostgreSQLPlayerPasskeyDAO extends PlayerPasskeyDAO {

    private static final Logger log = LoggerFactory.getLogger(PostgreSQLPlayerPasskeyDAO.class);

...
public class PostgreSQLPlayerSkillSkinListDAO extends PlayerSkillSkinListDAO {

    private static final Logger log = LoggerFactory.getLogger(PostgreSQLPlayerSkillSkinListDAO.class);
    
    private static final String LOAD_QUERY = "SELECT \"skin_id\", \"remaining\", \"active\" FROM \"player_skill_skins\" WHERE \"player_id\"=?";
    private static final String INSERT_QUERY = "INSERT INTO \"player_skill_skins\"(\"player_id\", \"skin_id\", \"remaining\", \"active\") VALUES (?,?,?,?) ON CONFLICT (player_id, skin_id) DO UPDATE SET remaining = EXCLUDED.remaining, \"active\" = VALUES(\"active\")";

...
/**
 * PostgreSQL implementation of PlayerQuestListDAO
 * 
 * @author MrPoke
 * @modified vlog, Rolandas
 * 
 */
public class PostgreSQLPlayerQuestListDAO extends PlayerQuestListDAO {

	private static final Logger log = LoggerFactory.getLogger(PostgreSQLPlayerQuestListDAO.class);

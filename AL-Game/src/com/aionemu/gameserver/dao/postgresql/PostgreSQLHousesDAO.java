...
/**
 * PostgreSQL implementation of HousesDAO
 * Fixed connection leaks
 */
public class PostgreSQLHousesDAO extends HousesDAO {
    
    private static final Logger log = LoggerFactory.getLogger(PostgreSQLHousesDAO.class);

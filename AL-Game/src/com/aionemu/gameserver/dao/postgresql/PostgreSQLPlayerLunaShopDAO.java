 ...
 */
public class PostgreSQLPlayerLunaShopDAO extends PlayerLunaShopDAO {

    private static final Logger log = LoggerFactory.getLogger(PostgreSQLPlayerLunaShopDAO.class);

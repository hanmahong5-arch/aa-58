...
/**
 * PostgreSQL implementation of HouseObjectCooldownsDAO
 * @author Rolandas
 */
public class PostgreSQLHouseObjectCooldownsDAO extends HouseObjectCooldownsDAO {

    private static final Logger log = LoggerFactory.getLogger(PostgreSQLHouseObjectCooldownsDAO.class);

    private static final String INSERT_QUERY = "INSERT INTO \"house_object_cooldowns\" (\"player_id\", \"object_id\", \"reuse_time\") VALUES (?, ?, ?) " + "ON CONFLICT (player_id, object_id) DO UPDATE SET reuse_time = EXCLUDED.reuse_time";

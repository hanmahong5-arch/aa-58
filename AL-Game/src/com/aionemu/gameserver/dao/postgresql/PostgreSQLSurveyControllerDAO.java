 ...
 */
public class PostgreSQLSurveyControllerDAO extends SurveyControllerDAO {

	private static final Logger log = LoggerFactory.getLogger(PostgreSQLSurveyControllerDAO.class);

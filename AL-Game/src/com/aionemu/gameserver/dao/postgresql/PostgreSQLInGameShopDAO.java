 ...
 * @author xTz
 */
public class PostgreSQLInGameShopDAO extends InGameShopDAO {

    private static final Logger log = LoggerFactory.getLogger(PostgreSQLInGameShopDAO.class);
    ...
    @Override
    public ConcurrentHashMap<Byte, List<IGItem>> loadInGameShopItems() {
        ConcurrentHashMap<Byte, List<IGItem>> items = new ConcurrentHashMap<>();

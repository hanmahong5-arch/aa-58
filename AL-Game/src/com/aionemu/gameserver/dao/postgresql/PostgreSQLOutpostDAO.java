...
/**
 * PostgreSQL implementation of OutpostDAO
 * Created by Wnkrz on 27/08/2017. PostgreSQL implementation.
 */
public class PostgreSQLOutpostDAO extends OutpostDAO {

    private static final Logger log = LoggerFactory.getLogger(PostgreSQLOutpostDAO.class);
    ...
    private static final String INSERT_QUERY = "INSERT INTO \"outpost_location\" (\"id\", \"race\") VALUES (?, ?) ON CONFLICT (id) DO UPDATE SET race = EXCLUDED.race";

...
/**
 * PostgreSQL implementation of F2pDAO
 * @author
 */
public class PostgreSQLF2pDAO extends F2pDAO {

    private static final Logger log = LoggerFactory.getLogger(PostgreSQLF2pDAO.class);

    private static final String INSERT_QUERY = "INSERT INTO \"f2paccount\" (\"player_id\", \"time\") VALUES (?, ?) " + "ON CONFLICT (player_id) DO UPDATE SET \"time\" = EXCLUDED.\"time\"";

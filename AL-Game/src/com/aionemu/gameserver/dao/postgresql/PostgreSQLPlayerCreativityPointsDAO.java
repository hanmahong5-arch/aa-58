 ...
 */
public class PostgreSQLPlayerCreativityPointsDAO extends PlayerCreativityPointsDAO {

	private static final Logger log = LoggerFactory.getLogger(PostgreSQLPlayerCreativityPointsDAO.class);

	private static final String INSERT_OR_UPDATE = "INSERT INTO \"player_cp\" (\"player_id\", \"slot\", \"point\") VALUES(?,?,?) " + "ON CONFLICT (player_id, slot) DO UPDATE SET slot = EXCLUDED.slot, point = EXCLUDED.point";

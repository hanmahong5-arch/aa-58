 ...
 */
public class PostgreSQLRewardServiceDAO extends RewardServiceDAO {

    private static final Logger log = LoggerFactory.getLogger(PostgreSQLRewardServiceDAO.class);

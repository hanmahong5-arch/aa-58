...
public class PostgreSQLAbyssSpecialLandingDAO extends AbyssSpecialLandingDAO {

    private static final Logger log = LoggerFactory.getLogger(PostgreSQLAbyssSpecialLandingDAO.class);

...
/**
 * PostgreSQL implementation of PlayerLifeStatsDAO
 * @author Mr. Poke
 */
public class PostgreSQLPlayerLifeStatsDAO extends PlayerLifeStatsDAO {

    private static final Logger log = LoggerFactory.getLogger(PostgreSQLPlayerLifeStatsDAO.class);

    private static final String INSERT_QUERY = "INSERT INTO \"player_life_stats\" (\"player_id\", \"hp\", \"mp\", \"fp\") VALUES (?, ?, ?, ?) " + "ON CONFLICT (player_id) DO UPDATE SET hp = EXCLUDED.hp, mp = EXCLUDED.mp, fp = EXCLUDED.fp";

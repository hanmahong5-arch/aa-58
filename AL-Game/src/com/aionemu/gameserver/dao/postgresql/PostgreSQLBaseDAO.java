...
/**
 * PostgreSQL implementation of BaseDAO
 * @author
 */
public class PostgreSQLBaseDAO extends BaseDAO {

    private static final Logger log = LoggerFactory.getLogger(PostgreSQLBaseDAO.class);
    ...
    private static final String INSERT_QUERY = "INSERT INTO \"base_location\" (\"id\", \"race\") VALUES (?, ?) ON CONFLICT (id) DO UPDATE SET race = EXCLUDED.race";

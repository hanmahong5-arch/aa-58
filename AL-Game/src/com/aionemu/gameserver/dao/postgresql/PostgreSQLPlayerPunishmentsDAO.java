 ...
 */
public class PostgreSQLPlayerPunishmentsDAO extends PlayerPunishmentsDAO {

	private static final Logger log = LoggerFactory.getLogger(PostgreSQLPlayerPunishmentsDAO.class);
	...
	private static final String REPLACE_QUERY = "INSERT INTO \"player_punishments\" (player_id, punishment_type, start_time, duration, reason) VALUES (?,?,?,?,?) ON CONFLICT (player_id, punishment_type) DO UPDATE SET start_time=EXCLUDED.start_time, duration=EXCLUDED.duration, reason=EXCLUDED.reason";

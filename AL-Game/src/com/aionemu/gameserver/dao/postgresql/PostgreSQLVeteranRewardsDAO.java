 ...
 */
public class PostgreSQLVeteranRewardsDAO extends VeteranRewardsDAO {

	private static final Logger log = LoggerFactory.getLogger(PostgreSQLVeteranRewardsDAO.class);

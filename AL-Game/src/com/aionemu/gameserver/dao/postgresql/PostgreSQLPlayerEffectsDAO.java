...
/**
 * PostgreSQL implementation of PlayerEffectsDAO
 * @author ATracer
 */
public class PostgreSQLPlayerEffectsDAO extends PlayerEffectsDAO {

    private static final Logger log = LoggerFactory.getLogger(PostgreSQLPlayerEffectsDAO.class);

    private static final String INSERT_QUERY = "INSERT INTO \"player_effects\" (\"player_id\", \"skill_id\", \"skill_lvl\", \"current_time\", \"end_time\") " + "VALUES (?, ?, ?, ?, ?) ON CONFLICT (player_id, skill_id) DO UPDATE SET skill_lvl = EXCLUDED.skill_lvl, current_time = EXCLUDED.current_time, end_time = EXCLUDED.end_time";

 ...
 */
public class PostgreSQLLadderDAO extends LadderDAO {

    private static final Logger log = LoggerFactory.getLogger(PostgreSQLLadderDAO.class);

    /** Whitelist of columns that may appear in dynamic SQL for ladder_player. */
    private static final Set<String> ALLOWED_COLUMNS = Set.of(
            "wins", "losses", "leaves", "rating", "rank");
     ...
     * @throws IllegalArgumentException if the column is not in ALLOWED_COLUMNS
     */
    private static void validateColumn(String column) {
        if (!ALLOWED_COLUMNS.contains(column)) {
            throw new IllegalArgumentException(
                    "Invalid ladder column: '" + column + "'. Allowed: " + ALLOWED_COLUMNS);
        }
    }

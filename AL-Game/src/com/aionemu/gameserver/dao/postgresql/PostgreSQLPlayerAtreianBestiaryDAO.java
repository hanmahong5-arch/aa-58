 ...
 * @author Ranastic
 */
public class PostgreSQLPlayerAtreianBestiaryDAO extends PlayerABDAO {

    private static final Logger log = LoggerFactory.getLogger(PostgreSQLPlayerAtreianBestiaryDAO.class);
    
    private static final String INSERT_OR_UPDATE = "INSERT INTO \"player_atreian_bestiary\" (\"player_id\", \"id\", \"kill_count\", \"level\", \"claim_reward\") VALUES(?,?,?,?,?) ON CONFLICT (player_id, id) DO UPDATE SET kill_count = EXCLUDED.kill_count, level = EXCLUDED.level, claim_reward = EXCLUDED.claim_reward";

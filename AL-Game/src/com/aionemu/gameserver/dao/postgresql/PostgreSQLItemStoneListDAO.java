...
/**
 * PostgreSQL implementation of ItemStoneListDAO
 */
public class PostgreSQLItemStoneListDAO extends ItemStoneListDAO {
    
    private static final Logger log = LoggerFactory.getLogger(PostgreSQLItemStoneListDAO.class);

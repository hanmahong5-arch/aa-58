 ...
 * @author Ranastic
 */
public class PostgreSQLPlayerWardrobeDAO extends PlayerWardrobeDAO {

    private static final Logger log = LoggerFactory.getLogger(PostgreSQLPlayerWardrobeDAO.class);
    
    private static final String INSERT_OR_UPDATE = "INSERT INTO \"player_wardrobe\" (\"player_id\", \"item_id\", \"slot\", \"reskin_count\") VALUES(?,?,?,?) ON CONFLICT (player_id, item_id) DO UPDATE SET item_id = EXCLUDED.item_id, slot = EXCLUDED.slot";

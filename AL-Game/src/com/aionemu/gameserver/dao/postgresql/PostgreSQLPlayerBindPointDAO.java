 ...
 */
public class PostgreSQLPlayerBindPointDAO extends PlayerBindPointDAO {

	private static final Logger log = LoggerFactory.getLogger(PostgreSQLPlayerBindPointDAO.class);

	private static final String INSERT_QUERY = "INSERT INTO \"player_bind_point\" (\"player_id\", \"map_id\", \"x\", \"y\", \"z\", \"heading\") VALUES (?,?,?,?,?,?) ON CONFLICT (player_id) DO UPDATE SET map_id=EXCLUDED.map_id, x=EXCLUDED.x, y=EXCLUDED.y, z=EXCLUDED.z, heading=EXCLUDED.heading";

 ...
 * @author KID
 */
public class PostgreSQLPlayerVarsDAO extends PlayerVarsDAO {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(PostgreSQLPlayerVarsDAO.class);
}
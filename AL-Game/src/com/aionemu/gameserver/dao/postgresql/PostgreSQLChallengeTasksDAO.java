 ...
 * @author ViAl
 */
public class PostgreSQLChallengeTasksDAO extends ChallengeTasksDAO {

    private static final Logger log = LoggerFactory.getLogger(PostgreSQLChallengeTasksDAO.class);

...
/**
 * PostgreSQL implementation of HouseScriptsDAO
 * @author Rolandas
 */
public class PostgreSQLHouseScriptsDAO extends HouseScriptsDAO {

    private static final Logger log = LoggerFactory.getLogger(PostgreSQLHouseScriptsDAO.class);

    private static final String MERGE_QUERY = "INSERT INTO \"house_scripts\" (\"house_id\", \"index\", \"script\") VALUES (?, ?, ?) " + "ON CONFLICT (house_id, \"index\") DO UPDATE SET script = EXCLUDED.script";

...
public class GiveStigma extends PlayerCommand {
    ...
    private void getStigmaStones(Player player, ArrayList<Integer> stoneList){
        for (Integer nValue : stoneList) {
            ItemService.addItem(player, n.getValue(), 1);
        }
    }

    private void getRidOfStigmaStones(Player player, ArrayList<Integer> stoneList){
        for (Integer nValue : stoneList){
            player.getInventory().decreaseByItemId(n.getValue(), 1);
        }
    }

    private ArrayList<Integer> glad(Player player, boolean getStoneIds){
    ...
    private ArrayList<Integer> temp(Player player, boolean getStoneIds){
        ArrayList<Integer> stones = new ArrayList<Integer>();
    ...
    private ArrayList<Integer> sin(Player player, boolean getStoneIds){
        ArrayList<Integer> stones = new ArrayList<Integer>();
    ...
    private ArrayList<Integer> ranger(Player player, boolean getStoneIds){
        ArrayList<Integer> stones = new ArrayList<Integer>();
    ...
    private ArrayList<Integer> sorc(Player player, boolean getStoneIds){
        ArrayList<Integer> stones = new ArrayList<Integer>();
    ...
    private ArrayList<Integer> sm(Player player, boolean getStoneIds){
        ArrayList<Integer> stones = new ArrayList<Integer>();
    ...
    private ArrayList<Integer> cleric(Player player, boolean getStoneIds){
        ArrayList<Integer> stones = new ArrayList<Integer>();
    ...
    private ArrayList<Integer> chanter(Player player, boolean getStoneIds){
        ArrayList<Integer> stones = new ArrayList<Integer>();
    ...
    private ArrayList<Integer> gunner(Player player, boolean getStoneIds){
        ArrayList<Integer> stones = new ArrayList<Integer>();
    ...
    private ArrayList<Integer> at(Player player, boolean getStoneIds){
        ArrayList<Integer> stones = new ArrayList<Integer>();
    ...
    private ArrayList<Integer> bard(Player player, boolean getStoneIds){
        ArrayList<Integer> stones = new ArrayList<Integer>();

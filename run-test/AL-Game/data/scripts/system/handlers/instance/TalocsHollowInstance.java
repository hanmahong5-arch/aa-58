...
public class TalocsHollowInstance extends GeneralInstanceHandler
{
	...
	private final ArrayList<Future<?>> talocTask = new ArrayList<>();
	private ConcurrentHashMap<Integer, VisibleObject> objects = new ConcurrentHashMap<Integer, VisibleObject>();

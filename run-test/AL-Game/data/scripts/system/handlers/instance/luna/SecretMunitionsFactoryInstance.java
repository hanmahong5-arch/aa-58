...
public class SecretMunitionsFactoryInstance extends GeneralInstanceHandler
{
	...
	private final ArrayList<Future<?>> factoryTask1 = new ArrayList<>();
	private final ArrayList<Future<?>> factoryTask2 = new ArrayList<>();
	...
	*/
	...
	private void stopInstanceTask1() {
        for (Future<?> nValue : factoryTask1) {
            if (nValue != null) {
                nValue.cancel(true);
            }
        }
	...
	private void stopInstanceTask2() {
        for (Future<?> nValue : factoryTask2) {
            if (nValue != null) {
                nValue.cancel(true);
            }
        }

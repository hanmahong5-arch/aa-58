...
public class TrialsOfEternityInstance extends GeneralInstanceHandler
{
	...
	private final ArrayList<Future<?>> trialsOfEternityTask = new ArrayList<>();
	private ConcurrentHashMap<Integer, VisibleObject> trialsShield = new ConcurrentHashMap<Integer, VisibleObject>();
	...
	private void stopInstanceTask() {
        for (Future<?> nValue : trialsOfEternityTask) {
            if (nValue != null) {
                nValue.cancel(true);
            }
        }

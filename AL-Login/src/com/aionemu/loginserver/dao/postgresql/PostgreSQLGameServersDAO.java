...
/**
 * PostgreSQL GameServers DAO implementation
 * 
 * @author
 */
public class PostgreSQLGameServersDAO extends GameServersDAO {
    
    private static final Logger log = LoggerFactory.getLogger(PostgreSQLGameServersDAO.class);

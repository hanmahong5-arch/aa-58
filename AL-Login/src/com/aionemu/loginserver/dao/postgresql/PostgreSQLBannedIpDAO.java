...
/**
 * PostgreSQL BannedIP DAO implementation
 * 
 * @author
 */
public class PostgreSQLBannedIpDAO extends BannedIpDAO {
    
    private static final Logger log = LoggerFactory.getLogger(PostgreSQLBannedIpDAO.class);

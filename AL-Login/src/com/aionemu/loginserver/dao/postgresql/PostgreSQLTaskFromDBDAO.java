...
/**
 * PostgreSQL TaskFromDB DAO implementation
 * 
 * @author
 */
public class PostgreSQLTaskFromDBDAO extends TaskFromDBDAO {

    private static final Logger log = LoggerFactory.getLogger(PostgreSQLTaskFromDBDAO.class);

...
/**
 * PostgreSQL Server Statistics DAO implementation
 * 
 * @author
 */
public class PostgreSQLSvStatsDAO extends SvStatsDAO {
    
    private static final Logger log = LoggerFactory.getLogger(PostgreSQLSvStatsDAO.class);

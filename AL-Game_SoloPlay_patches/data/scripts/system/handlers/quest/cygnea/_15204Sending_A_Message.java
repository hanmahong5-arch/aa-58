...
public class _15204Sending_A_Message extends QuestHandler {

	private final static int questId = 15204;
    private final static int REQUIRED_KILLS = 5; // summ of NPC needed to kill
	...
	public _15204Sending_A_Message() {
		super(questId);
	}
    ...
    public boolean onKillEvent(QuestEnv env) {
        ...
        if (env.getVisibleObject() instanceof Player && player.getWorldId() == 210070000) {
        ...
        if (killCounted) {
            ...
            if (killCount >= REQUIRED_KILLS) {
                ...
                qs.setStatus(QuestStatus.REWARD); // If we made MOBS_KILLS = 5 of NPC, then make status REWARD
            }

...
public class _2881_5th_Rank_Elyos extends QuestHandler {
    ...
    private final static int REQUIRED_KILLS = 3; // summ of NPC needed to kill
    ...
    public boolean onKillEvent(QuestEnv env) {
        ...
        if (killCounted) {
            ...
            if (killCount >= REQUIRED_KILLS) {
                ...
                qs.setStatus(QuestStatus.REWARD); // If we made MOBS_KILLS = 3 of NPC, then make status REWARD
            }

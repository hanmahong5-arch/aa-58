...
public class _13883Split_Them_Up extends QuestHandler {
    ...
    private final static int REQUIRED_KILLS = 6; // summ of NPC needed to kill
    ...
    public boolean onKillEvent(QuestEnv env) {
        ...
        if (env.getVisibleObject() instanceof Player && player.getWorldId() == 600090000) {
        ...
        if (killCounted) {
            ...
            if (killCount >= REQUIRED_KILLS) {
                ...
                qs.setStatus(QuestStatus.REWARD); // If we made MOBS_KILLS = 6 of NPC, then make status REWARD
            }

		...
		if (isAggred.compareAndSet(false, true)) {
			switch (getNpcId()) {
				case 234686: //Remodeled Dynatoum.
					/**
					 * You have about 10 minutes to finish the boss, so all party members must be ready before activating the seal.
					 */
					...
					NpcShoutsService.getInstance().sendMsg(getOwner(), 1402427, 540000);
					//The Remodeled Dynatoum is going to explode.
					NpcShoutsService.getInstance().sendMsg(getOwner(), 1402428, 600000);
